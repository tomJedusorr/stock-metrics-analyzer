def get_lse_tickers():
    ...
    # URL of the Wikipedia page containing the SP500 constituents
    url = "https://en.wikipedia.org/wiki/FTSE_100_Index?utm_source=chatgpt.com"
    ...
    tsx_tickers = [ticker.strip().upper() + ".L" for ticker in tickers]
    ticker_string = ", ".join(tsx_tickers)

    return ticker_string

if __name__ == "__main__":
    result = get_lse_tickers()
    print(result)